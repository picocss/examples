...
<html lang="en" ⚡<?=isset($_GET['theme']) ? ' data-theme="' . $_GET['theme'] . '"' : '' ?>>
  ...
  <body>
    ...
    <main>
      ...
      <p>For this example, we have compiled a custom and class-less version of pico (<a href="https://github.com/picocss/examples/google-amp/scss/pico.google-amp.scss">See here</a>).</p>
